		...
		description: [
			{
				...
				connecting: {
					name: "Connectivity",
					con1: { text: "Ethernet", has: false },
					con2: { text: "Cellular", has: true },
					con3: { text: "Wi-Fi", has: true },
					con4: { text: "Bluetooth", has: true },
				},
			},
		],
	},
		...
		description: [
			{
				...
				connecting: {
					name: "Connectivity",
					con1: { text: "Ethernet", has: false },
					con2: { text: "Cellular", has: false },
					con3: { text: "Wi-Fi", has: false },
					con4: { text: "Bluetooth", has: false },
				},
			},
		],
	},
