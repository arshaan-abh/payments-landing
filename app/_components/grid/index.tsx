...
const Grid: FC<GridProps> = ({ black }) => {
	...
	return (
		<div className="pointer-events-none fixed inset-0 top-[9.0625rem] flex h-full w-full select-none flex-col justify-evenly px-10 lg:px-20 xl:max-w-screen-1.5xl xl:px-30">
