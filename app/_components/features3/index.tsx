			...
			<div className="col-span-6 flex flex-col justify-between mb-10">
				...
				<div className="grid grid-cols-6">
					...
					<div className="col-span-5 flex flex-col justify-center">
						...
						<p className="font-normal text-base text-gray_2">
							Customise payments to perfectly align with your unique commission
							model, ensuring a tailored and efficient payment process.
						</p>
					</div>
				</div>
				<div className="grid grid-cols-6">
					...
					<div className="col-span-5 flex flex-col justify-center">
						...
						<p className="font-normal text-base text-gray_2">
							Simplify the process with automation, ensuring swift and efficient
							settlement procedures that save you time and effort.
						</p>
					</div>
				</div>
				<div className="grid grid-cols-6">
					...
					<div className="col-span-5 flex flex-col justify-center">
						...
						<p className="font-normal text-base text-gray_2">
							...
							financial transactions more accessible and efficient for everyone
							involved.
						</p>
					</div>
				</div>
