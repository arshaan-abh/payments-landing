	...
	return (
		<>
			...
			<div
				...
				className="fixed inset-x-0 bottom-12 mx-auto flex h-16 w-fit items-center justify-center overflow-hidden rounded-rectangle-full bg-[#1616161a] p-2 backdrop-blur-sm transition-all duration-300"
				style={{
