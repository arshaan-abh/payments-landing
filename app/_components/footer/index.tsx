...
function Footer() {
	return (
		<div className="grid grid-cols-12 bg-primery mt-10 pl-5 lg:pl-0 lg:px-[80px] xl:px-[120px]">
				...
				<div className="col-span-12 lg:col-span-4 mb-5 mt-10 lg:mt-0 pr-5">
					...
					<div className="my-3">
						<p className="text-secondary text-sm font-medium">
							Get the latest news and exclusive promotions conveniently in your
							inbox.
						</p>
					</div>
					<div className="my-3">
